...
namespace prjDVD
{
    ...
    public partial class frmDVDCatalog : Form
    {
        ...
        void ResetFields(bool status)
        {
            ...
            radYes.Checked = true; radNo.Checked = false;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand con = new SqlCommand("Select Max(DVDCodeNo) from DVDLibrary", clsDatabase.con);
    ...
    class clsDatabase
    {
        ...
        public static bool OpenConnection()
        {
            try
            {
                ...
                con = new SqlConnection("Data Source=DESKTOP-6A8IVC0\\SQLEXPRESS;Initial Catalog=DVDLibrary;Integrated Security=true;uid=mylogin;pwd=mylogin");
                con.Open();
            }
            catch (Exception)
            {
